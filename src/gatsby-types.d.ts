...
type steSeoMetadataQueryVariables = Exact<{ [key: string]: never; }>;


type steSeoMetadataQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null, readonly author: string | null, readonly keywords: string | null, readonly siteUrl: string | null } | null } | null, readonly og: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null };
